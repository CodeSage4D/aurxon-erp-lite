...
const ALLOWED_TABS_MAP: Record<string, string[]> = {
  FOUNDER: ['overview', 'registrations', 'orgs', 'security', 'impersonate', 'backups', 'plans'],
  CO_FOUNDER: ['overview', 'registrations', 'orgs', 'security', 'impersonate', 'backups', 'plans'],
  PLATFORM_DIRECTOR: ['overview', 'registrations', 'orgs', 'security', 'impersonate', 'backups', 'plans'],
  ...
  TECHNICAL_ADMINISTRATOR: ['overview', 'security', 'backups']
};
